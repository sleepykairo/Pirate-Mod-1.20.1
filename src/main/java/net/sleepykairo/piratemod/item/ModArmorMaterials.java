...
public enum ModArmorMaterials implements ArmorMaterial {
    SEA("sea", 37, new int[] { 3, 8, 6, 3 }, 15,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.0f, 0.0f, () -> Ingredient.ofItems(ModItems.OCEAN_INGOT));
    ...
    public String getName() {
        return PirateMod.MOD_ID + ":" + this.name;
    }
