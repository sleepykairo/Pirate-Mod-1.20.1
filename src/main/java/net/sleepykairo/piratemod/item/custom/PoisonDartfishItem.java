...
public class PoisonDartfishItem extends Item {
    public PoisonDartfishItem(Settings settings) {
        super(settings);
    }
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            PoisonDartfishProjectileEntity dartfishEntity = new PoisonDartfishProjectileEntity(world, user);
