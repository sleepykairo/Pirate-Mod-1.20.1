...
public class AlchemyTableScreenHandler extends ScreenHandler {
    ...
    public AlchemyTableScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        ...
        this.addSlot(new Slot(inventory, 0, 36, 53));
        this.addSlot(new Slot(inventory, 1, 60, 33));
        this.addSlot(new Slot(inventory, 2, 80, 23));
        this.addSlot(new Slot(inventory, 3, 80, 43));
        this.addSlot(new Slot(inventory, 4, 100, 33));
        this.addSlot(new Slot(inventory, 5, 124, 53));
    ...
    public ItemStack quickMove(PlayerEntity player, int invSlot) {
        ...
        PirateMod.LOGGER.info(Integer.toString(invSlot));
