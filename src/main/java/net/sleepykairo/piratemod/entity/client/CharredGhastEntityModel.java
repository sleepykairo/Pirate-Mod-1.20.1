...
public class CharredGhastEntityModel<T extends CharredGhastEntity> extends SinglePartEntityModel<T> {
    private final ModelPart body;
    private final ModelPart head;
    public CharredGhastEntityModel(ModelPart root) {
    ...
    @Override
    public void setAngles(CharredGhastEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
    @Override
